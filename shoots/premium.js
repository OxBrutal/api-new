...
const { checkUsername, resetAllLimit } = require('../place/db');
const { addPremium, deletePremium, checkPremium, changeKey, resetOneLimit, resetTodayReq } = require('../place/premium');
